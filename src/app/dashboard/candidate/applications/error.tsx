...
export default function CandidateApplicationsError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto flex min-h-[420px] max-w-7xl items-center justify-center">
      <section className="max-w-md rounded-xl border border-border bg-surface p-6 text-center shadow-xs">
        ...
        <h1 className="mt-4 text-lg font-bold tracking-tight text-foreground">Applications are temporarily unavailable</h1>
        <p className="mt-2 text-sm leading-6 text-text-secondary">
          We couldn&apos;t retrieve your application history just now. Your submissions are unchanged.
        </p>
